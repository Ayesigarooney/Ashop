            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(DateFormatter.formatReceiptDate(sale.createdAt),
                      style: const pw.TextStyle(fontSize: 9)),
                ],
              ),
              pw.Divider(),
              ...
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text('Paid (${sale.paymentMethod}):',
                      style: const pw.TextStyle(fontSize: 9)),
                  pw.Text(
              ...
              if (sale.change > 0)
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text(
                        CurrencyFormatter.format(sale.change,
                            currency: currency),
                        style: const pw.TextStyle(fontSize: 9)),
                  ],
                ),
