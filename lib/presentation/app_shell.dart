...
class AppShellState extends State<AppShell> {
  ...
  final List<_NavItem> _navItems = [
    ...
    _NavItem(icon: Icons.point_of_sale_outlined, activeIcon: Icons.point_of_sale_rounded, label: 'POS'),
    ...
    _NavItem(icon: Icons.note_alt_outlined, activeIcon: Icons.note_alt_rounded, label: 'Notes'),
        ...
        body: Row(
          children: [
            NavigationRail(
              ...
              unselectedIconTheme: IconThemeData(color: theme.colorScheme.onSurface.withOpacity(0.4)),
              selectedLabelTextStyle: GoogleFonts.inter(fontSize: 11, fontWeight: FontWeight.w700, color: AppTheme.primaryColor),
              unselectedLabelTextStyle: GoogleFonts.inter(fontSize: 11, color: theme.colorScheme.onSurface.withOpacity(0.4)),
